...
nMeter.service('webapi', ['$http', function($http){
		return {
			getLatency: function(callback){
	  		...
	  		getResponseTime: function(callback, error){
	  			return $http.get('api/responseTime').success(callback).error(error)
	  		},
	  		...
	  		setConfig: function(data, callback){
  				return $http.post('api/save', data).success(callback)
	  		},
...
nMeter.service('charttheme',function(){
